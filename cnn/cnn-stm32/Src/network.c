...
#define AI_NETWORK_MODEL_SIGNATURE     "e7459ecd291946e2ae2b30df961825bc"
...
#define AI_TOOLS_DATE_TIME   "Mon Nov 29 17:39:24 2021"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 2304, 2, 1, 1), AI_STRIDE_INIT(4, 1, 1152, 2304, 2304),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    conv2d_1_scratch0_array.data = AI_PTR(activations_map[0] + 30592);
