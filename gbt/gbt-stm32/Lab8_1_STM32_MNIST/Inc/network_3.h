...
#define AI_NETWORK_3_ORIGIN_MODEL_NAME   "simple_svc_clf"
...
#define AI_NETWORK_3_IN_1_CHANNEL     (512)
#define AI_NETWORK_3_IN_1_SIZE        (512)
#define AI_NETWORK_3_IN_1_SIZE_BYTES  (AI_NETWORK_3_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_3_OUT_NUM       (2)
...
#define AI_NETWORK_3_OUT_SIZE { \
  ...
  AI_NETWORK_3_OUT_2_SIZE, \
}
#define AI_NETWORK_3_OUT_SIZE_BYTES { \
  AI_NETWORK_3_OUT_1_SIZE_BYTES, \
  AI_NETWORK_3_OUT_2_SIZE_BYTES, \
}
#define AI_NETWORK_3_OUT_1_CHANNEL     (1)
#define AI_NETWORK_3_OUT_1_SIZE        (1)
#define AI_NETWORK_3_OUT_1_SIZE_BYTES  (AI_NETWORK_3_OUT_1_SIZE * 4)
#define AI_NETWORK_3_OUT_2_CHANNEL     (2)
#define AI_NETWORK_3_OUT_2_SIZE        (2)
#define AI_NETWORK_3_OUT_2_SIZE_BYTES  (AI_NETWORK_3_OUT_2_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_3_N_NODES (1)
