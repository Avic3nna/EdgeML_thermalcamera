...
#define AI_NETWORK_1_IN_1_SIZE  (28 * 28 * 1)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  ((28 * 28 * 1) * 4)
...
#define AI_NETWORK_1_OUT_1_SIZE  (1 * 1 * 10)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)

#define AI_NETWORK_1_N_NODES (10)
