...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (4384)

#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)

#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (155520)
...
#define AI_NETWORK_1_DATA_ACTIVATIONS(ptr_)  \
  AI_BUFFER_OBJ_INIT( \
    AI_BUFFER_FORMAT_U8, \
    AI_NETWORK_1_DATA_ACTIVATIONS_COUNT, 1, AI_NETWORK_1_DATA_ACTIVATIONS_SIZE, 1, \
    AI_HANDLE_PTR(ptr_) )

#define AI_NETWORK_1_DATA_WEIGHTS(ptr_)  \
  AI_BUFFER_OBJ_INIT( \
    AI_BUFFER_FORMAT_U8|AI_BUFFER_FMT_FLAG_CONST, \
    AI_NETWORK_1_DATA_WEIGHTS_COUNT, 1, AI_NETWORK_1_DATA_WEIGHTS_SIZE, 1, \
    AI_HANDLE_PTR(ptr_) )
 ...
 */
AI_API_ENTRY
ai_bool ai_network_1_data_params_get(ai_handle network, ai_network_params* params);
